            ...
            <div class="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
                <div class="flex items-start space-x-3">
                    <iconify-icon icon="heroicons:exclamation-triangle-20-solid"
                        class="w-5 h-5 text-red-600 dark:text-red-400 mt-0.5"></iconify-icon>
                    <div>
                        <h3 class="text-sm font-medium text-red-800 dark:text-red-200 mb-2">Terjadi kesalahan pada form:
                        </h3>
