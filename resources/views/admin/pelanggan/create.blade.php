...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Daftarkan pelanggan baru ke sistem</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            <form method="POST" action="{{ route('admin.pelanggan.store') }}" class="p-6">
                @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="no_sim" id="no_sim" value="{{ old('no_sim') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                                    value="{{ old('tanggal_lahir') }}" max="{{ date('Y-m-d', strtotime('-17 years')) }}"
